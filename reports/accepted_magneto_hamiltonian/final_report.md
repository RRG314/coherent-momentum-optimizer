...
- Meaningful wins vs `real_hamiltonian_adam`: 13

## 3. Whether it beat MagnetoAdam alone
- Meaningful wins vs `magneto_adam`: 7
...
- Tasks where it beat Real Hamiltonian and AdamW while staying competitive with RMSProp: direction_reversal_objective, noisy_quadratic_objective, oscillatory_valley, quadratic_bowl_objective, saddle_objective
...
- Mean relative energy drift on direct energy tests: Real `-0.001439` vs Magneto-Hamiltonian `-0.003154`
...
| --- | --- | --- | --- | --- |
| magneto_hamiltonian_adam | breast_cancer_mlp | 0.0799 | 0.9805 | -0.0011 |
| real_hamiltonian_adam | conflicting_batches_classification | 0.0857 | 0.9779 | -0.0035 |
| magneto_adam | circles_mlp | 0.0961 | 0.9888 | nan |
