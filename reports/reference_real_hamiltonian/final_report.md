...
This report uses the optimizer names and literature links collected in [../../REFERENCES.md](../../REFERENCES.md). The baseline role of `HamiltonianAdamReal` is explained in [../../docs/REAL_BASELINE.md](../../docs/REAL_BASELINE.md).
...
- Mean relative energy drift on direct energy tests: V1 `nan` vs Real `-0.001617`
...
- Tasks where it beat V1 and AdamW while staying competitive with RMSProp: oscillatory_valley, saddle_objective
...
| --- | --- | --- | --- | --- |
| hamiltonian_adam | circles_mlp | 0.1029 | 0.9862 | nan |
| real_hamiltonian_adam | breast_cancer_mlp | 0.1141 | 0.9635 | -0.0065 |
...
| oscillatory_valley | real_hamiltonian_adam | -0.2340 | nan |
...
| small_batch_instability | hamiltonian_adam | 0.3799 | 0.8760 |
