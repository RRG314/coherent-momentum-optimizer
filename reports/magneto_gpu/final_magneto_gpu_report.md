...
| --- | --- | --- | --- |
| magneto_hamiltonian_adam | adamw | 7 | 2 |
| magneto_hamiltonian_adam | rmsprop | 5 | 0 |
| magneto_hamiltonian_adam | sgd_momentum | 5 | 0 |
| magneto_hamiltonian_adam | real_hamiltonian_adam | 8 | 2 |
| magneto_hamiltonian_adam | magneto_adam | 7 | 4 |
| magneto_hamiltonian_adam | topological_adam | 7 | 3 |
| magneto_hamiltonian_adam_improved | adamw | 7 | 3 |
| magneto_hamiltonian_adam_improved | rmsprop | 7 | 0 |
| magneto_hamiltonian_adam_improved | sgd_momentum | 5 | 0 |
| magneto_hamiltonian_adam_improved | real_hamiltonian_adam | 9 | 3 |
| magneto_hamiltonian_adam_improved | magneto_adam | 7 | 6 |
| magneto_hamiltonian_adam_improved | topological_adam | 7 | 3 |
| magneto_hamiltonian_adam_improved | magneto_hamiltonian_adam | 8 | 3 |

## Best Rows
| optimizer | task | mean_best_val_loss | mean_best_val_accuracy | mean_runtime_per_step_ms | mean_peak_device_memory_mb |
| --- | --- | --- | --- | --- | --- |
| magneto_hamiltonian_adam_improved | breast_cancer_mlp | 0.1731 | 0.9531 | 10.5769 | nan |
| magneto_hamiltonian_adam | conflicting_batches_classification | 0.1057 | 0.9761 | 5.0887 | nan |
...
| --- | --- | --- | --- | --- | --- |
| magneto_hamiltonian_adam | digits_cnn_label_noise | 2.2984 | 0.1723 | 13.7997 | 8.8728 |
| magneto_hamiltonian_adam_improved | digits_cnn | 2.2960 | 0.1900 | 19.8271 | 14.9565 |
...
| real_hamiltonian_adam | digits_cnn | 2.2946 | 0.1739 | 12.3951 | 7.5972 |
| magneto_adam | digits_cnn | 0.7626 | 0.7753 | 7.0569 | 2.2672 |

## Stress Snapshot
| optimizer | task | best_val_loss | best_val_accuracy | runtime_per_step_ms | optimizer_step_time_ms |
| --- | --- | --- | --- | --- | --- |
| magneto_hamiltonian_adam | saddle_objective | -4.1298 | nan | 1.2678 | 1.0393 |
| magneto_hamiltonian_adam_improved | saddle_objective | -4.1322 | nan | 1.8533 | 1.6365 |
...
| real_hamiltonian_adam | saddle_objective | -4.1028 | nan | 1.0033 | 0.7939 |
| magneto_adam | saddle_objective | -3.1715 | nan | 0.5805 | 0.3785 |

## Multitask / Conflict Snapshot
| optimizer | task | best_val_loss | best_val_accuracy | runtime_per_step_ms | optimizer_step_time_ms |
| --- | --- | --- | --- | --- | --- |
| magneto_hamiltonian_adam | conflicting_batches_classification | 0.0684 | 0.9844 | 5.0616 | 4.1910 |
| magneto_hamiltonian_adam_improved | conflicting_batches_classification | 0.1090 | 0.9766 | 9.4455 | 8.5347 |
...
| real_hamiltonian_adam | conflicting_batches_classification | 0.0748 | 0.9844 | 4.1682 | 3.3040 |
| magneto_adam | conflicting_batches_classification | 0.0508 | 0.9883 | 2.6257 | 1.7209 |
...
| rosenbrock_valley | magneto_hamiltonian_adam_improved | 0.0000 | nan |
...
| magneto_adam | 1.9195 | 1.0713 | 4531.6902 | 0.0226 | nan |
| real_hamiltonian_adam | 4.4366 | 3.0581 | 3045.8466 | 0.0338 | nan |
| magneto_hamiltonian_adam | 5.1188 | 3.7364 | 2577.9964 | 0.0405 | nan |
| magneto_hamiltonian_adam_improved | 8.2828 | 6.8906 | 1540.6628 | 0.0405 | nan |

## Direct Answers
- Is Magneto-Hamiltonian GPU-capable? `yes`
