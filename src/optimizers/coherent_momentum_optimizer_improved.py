...
class CoherentMomentumOptimizerImproved(CoherentMomentumRealBaseline):
    ...
    def __init__(
        ...
        self._initialize_physical_optimizer("CoherentMomentumOptimizerImproved")
        self._apply_preset()
    ...
    def _compute_controls_tensor(
        ...
        *,
        ...
        coherence_activation = _clamp_tensor(
        ...
        projection_source = coherence_activation
        ...
        for group in self.param_groups:
            ...
            for param in group["params"]:
                ...
                if capture_diagnostics:
                    ...
                    diagnostics["coherence_projection_strength"].append(safe_float(controls["projection_strength"]))
                    diagnostics["coherence_friction_multiplier"].append(safe_float(controls["friction_multiplier"]))
