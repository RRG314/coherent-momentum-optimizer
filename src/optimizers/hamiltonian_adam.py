...
class HamiltonianAdam(PhysicalOptimizerBase, torch.optim.Optimizer):
    def __init__(
        self,
        params,
        lr: float = 1e-3,
        ...
        self._initialize_physical_optimizer("HamiltonianAdam")
...
class HamiltonianAdamV2(PhysicalOptimizerBase, torch.optim.Optimizer):
    def __init__(
        self,
        params,
        lr: float = 1e-3,
        ...
        super().__init__(params, defaults)
        self._initialize_physical_optimizer("HamiltonianAdamV2")

    def _legacy_step_for_param(
        self,
        *,
        param: torch.Tensor,
        grad: torch.Tensor,
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            ...
            legacy_v1_mode = bool(group["legacy_v1_mode"])
            ...
            for param in group["params"]:
                ...
                state = self.state[param]
                if legacy_v1_mode:
                    row = self._legacy_step_for_param(
                        param=param,
                        grad=grad,
                        state=state,
                        lr=lr,
...
class HamiltonianAdamV2RMSPropForce(HamiltonianAdamV2):
    def __init__(self, params, **kwargs) -> None:
        kwargs.setdefault("force_mode", "rmsprop")
        super().__init__(params, **kwargs)


class HamiltonianAdamReal(PhysicalOptimizerBase, torch.optim.Optimizer):
    _VALID_MODES = {
        "symplectic_euler",
    ...
    def __init__(
        ...
        self._initialize_physical_optimizer("HamiltonianAdamReal")
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            ...
            for param in group["params"]:
                ...
                if mode == "hamiltonian_adam_v1_compatibility":
        ...
        diagnostics_row = {
            ...
            "update_mode_code": {
                ...
                "hamiltonian_adam_v1_compatibility": 4.0,
...
SymplecticAdam = HamiltonianAdamReal
