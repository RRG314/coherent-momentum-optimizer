...
from optimizers.block_direction_optimizer import BlockDirectionOptimizer
from optimizers.block_direction_optimizer_v2 import BlockDirectionOptimizerV2
from optimizers.block_direction_optimizer_v3 import BlockDirectionOptimizerV3
from optimizers.block_direction_optimizer_v4_fast import BlockDirectionOptimizerV4Fast
from optimizers.block_direction_optimizer_v41 import BlockDirectionOptimizerV41
from optimizers.block_direction_optimizer_v42 import BlockDirectionOptimizerV42
from optimizers.block_direction_optimizer_v43 import BlockDirectionOptimizerV43
from optimizers.block_direction_optimizer_v44 import BlockDirectionOptimizerV44
from optimizers.block_direction_optimizer_v45 import BlockDirectionOptimizerV45
...
from optimizers.hamiltonian_adam import HamiltonianAdam, HamiltonianAdamReal, HamiltonianAdamV2
from optimizers.magneto_adam import MagnetoAdam
from optimizers.magneto_hamiltonian_adam import MagnetoHamiltonianAdam
from optimizers.magneto_hamiltonian_adam_improved import MagnetoHamiltonianAdamImproved
...
def build_optimizer_registry() -> dict[str, OptimizerSpec]:
    return {
        ...
        "hamiltonian_adam": OptimizerSpec(
            "hamiltonian_adam",
            HamiltonianAdam,
            {
                "lr": 1e-3,
        ...
        "hamiltonian_adam_v2": OptimizerSpec(
            "hamiltonian_adam_v2",
            HamiltonianAdamV2,
            {
                "lr": 1e-3,
        ...
        "real_hamiltonian_adam": OptimizerSpec(
        ...
        "magneto_hamiltonian_adam": OptimizerSpec(
        ...
        "magneto_hamiltonian_adam_improved": OptimizerSpec(
        ...
        "block_direction_optimizer": OptimizerSpec(
            "block_direction_optimizer",
            BlockDirectionOptimizer,
            {
                "lr": 1e-2,
                "weight_decay": 0.0,
                "memory_decay": 0.85,
                "grad_decay": 0.95,
                "coherence_strength": 0.35,
                "norm_ratio_strength": 0.20,
                "conflict_penalty": 0.18,
                "blend_strength": 0.10,
                "recoverability_strength": 0.08,
                "recoverability_keep_ratio": 0.55,
                "recoverability_samples": 2,
                "dimension_power": 0.0,
                "max_update_ratio": 0.12,
                "min_scale": 0.60,
                "max_scale": 1.65,
                "use_signed_consensus": True,
            },
            {
                "lr": [5e-2, 2e-2, 1e-2, 5e-3, 3e-3],
                "weight_decay": [0.0, 1e-5, 1e-4],
                "memory_decay": [0.75, 0.85, 0.92, 0.97],
                "grad_decay": [0.9, 0.95, 0.98],
                "coherence_strength": [0.15, 0.35, 0.55],
                "norm_ratio_strength": [0.0, 0.2, 0.35],
                "conflict_penalty": [0.08, 0.18, 0.3],
                "blend_strength": [0.0, 0.1, 0.28, 0.45],
                "recoverability_strength": [0.0, 0.08, 0.18, 0.35],
                "recoverability_keep_ratio": [0.4, 0.55, 0.7],
                "recoverability_samples": [1, 2, 3],
                "dimension_power": [0.0, 0.18, 0.3],
                "max_update_ratio": [0.08, 0.12, 0.2, 0.35],
                "min_scale": [0.6, 0.8, 1.0],
                "max_scale": [1.4, 1.65, 2.0],
                "use_signed_consensus": [False, True],
            },
        ),
        "block_direction_optimizer_v2": OptimizerSpec(
            "block_direction_optimizer_v2",
            BlockDirectionOptimizerV2,
            {
                "lr": 2e-2,
                "weight_decay": 0.0,
                "block_strategy": "smart",
                ...
                "trust_decay": 0.88,
                "descent_weight": 0.42,
                "coherence_weight": 0.18,
                "improvement_weight": 0.10,
                "recoverability_weight": 0.12,
                "stability_weight": 0.10,
                "oscillation_penalty": 0.14,
                "conflict_penalty": 0.12,
                "cost_penalty_weight": 0.04,
                "recovery_threshold": 0.48,
                "recoverability_keep_ratio": 0.55,
                "recoverability_noise_scale": 0.04,
                "recoverability_drop_fraction": 0.15,
                "recoverability_samples": 2,
                "topk_fraction": 0.20,
                "projection_strength": 0.45,
                "orthogonal_strength": 0.30,
                "dimension_power": 0.10,
                "max_update_ratio": 0.16,
                "min_scale": 0.55,
                "max_scale": 1.85,
                "fallback_threshold": 0.08,
                "magnitude_mode": "block_norm",
                "rmsprop_decay": 0.97,
                "use_gradient_candidate": True,
                "use_normalized_gradient_candidate": True,
                "use_trusted_direction_candidate": True,
                "use_smoothed_direction_candidate": True,
                ...
                "use_sign_candidate": True,
                "use_muon_like_candidate": False,
            },
            {
                "lr": [5e-2, 2e-2, 1e-2, 5e-3],
                "weight_decay": [0.0, 1e-5, 1e-4],
                "block_strategy": ["smart", "row", "column", "tensor", "scalar"],
                "selection_mode": ["winner_take_all", "top2_blend", "softmax_weighted_average", "fallback_to_gradient"],
                "selection_temperature": [0.25, 0.35, 0.6],
                "memory_decay": [0.82, 0.90, 0.96],
                "smooth_decay": [0.90, 0.94, 0.98],
                "grad_decay": [0.92, 0.96, 0.99],
                "trust_decay": [0.82, 0.88, 0.94],
                "descent_weight": [0.30, 0.42, 0.55],
                "coherence_weight": [0.08, 0.18, 0.30],
                "improvement_weight": [0.0, 0.10, 0.20],
                "recoverability_weight": [0.0, 0.12, 0.25],
                "stability_weight": [0.0, 0.10, 0.18],
                "oscillation_penalty": [0.05, 0.14, 0.25],
                "conflict_penalty": [0.05, 0.12, 0.22],
                "cost_penalty_weight": [0.0, 0.04, 0.08],
                "recovery_threshold": [0.35, 0.48, 0.60],
                "recoverability_keep_ratio": [0.45, 0.55, 0.70],
                "recoverability_noise_scale": [0.0, 0.04, 0.08],
                "recoverability_drop_fraction": [0.0, 0.15, 0.30],
                "recoverability_samples": [1, 2, 3],
                "topk_fraction": [0.10, 0.20, 0.33],
                "projection_strength": [0.25, 0.45, 0.70],
                "orthogonal_strength": [0.0, 0.30, 0.50],
                "dimension_power": [0.0, 0.10, 0.25],
                "max_update_ratio": [0.08, 0.16, 0.30],
                "min_scale": [0.55, 0.75, 1.0],
                "max_scale": [1.4, 1.85, 2.2],
                "fallback_threshold": [0.0, 0.08, 0.20],
                "magnitude_mode": ["block_norm", "rmsprop_like"],
            },
            {
                "block_strategy": "tensor",
        ...
        "block_direction_optimizer_v3": OptimizerSpec(
            "block_direction_optimizer_v3",
            BlockDirectionOptimizerV3,
            {
                "lr": 1.8e-2,
                "weight_decay": 0.0,
                "block_strategy": "smart_v3",
                ...
                "trust_decay": 0.90,
                "descent_weight": 0.48,
                "coherence_weight": 0.22,
                "improvement_weight": 0.08,
                "recoverability_weight": 0.05,
                "stability_weight": 0.12,
                "oscillation_penalty": 0.16,
                "conflict_penalty": 0.16,
                "cost_penalty_weight": 0.03,
                "recovery_threshold": 0.52,
                "recoverability_keep_ratio": 0.50,
                "recoverability_noise_scale": 0.03,
                "recoverability_drop_fraction": 0.10,
                "recoverability_samples": 1,
                "topk_fraction": 0.18,
                "projection_strength": 0.0,
                "orthogonal_strength": 0.0,
                "dimension_power": 0.08,
                "max_update_ratio": 0.18,
                "min_scale": 0.70,
                "max_scale": 1.75,
                ...
                "use_sign_candidate": True,
                "use_muon_like_candidate": False,
                "matrix_candidate_mode": "row_column_consensus",
                "row_column_mix": 0.6,
                "row_column_energy_weight": 0.55,
                "use_stable_consensus_candidate": True,
                "consensus_memory_mix": 0.42,
                "consensus_matrix_mix": 0.18,
                "stable_consensus_bonus": 0.12,
                "matrix_consensus_bonus": 0.06,
                "stress_gate_threshold": 0.28,
                "stress_gate_power": 1.0,
                "stress_candidate_penalty": 0.16,
            },
            {
                "lr": [3e-2, 1.8e-2, 1e-2, 5e-3],
                "weight_decay": [0.0, 1e-5, 1e-4],
                "block_strategy": ["smart_v3", "row", "column", "scalar", "tensor"],
                "selection_mode": ["winner_take_all", "top2_blend", "softmax_weighted_average", "fallback_to_gradient"],
                "selection_temperature": [0.2, 0.3, 0.5],
                "memory_decay": [0.82, 0.88, 0.94],
                "smooth_decay": [0.94, 0.96, 0.98],
                "grad_decay": [0.95, 0.97, 0.99],
                "trust_decay": [0.86, 0.90, 0.94],
                "descent_weight": [0.40, 0.48, 0.58],
                "coherence_weight": [0.14, 0.22, 0.30],
                "improvement_weight": [0.0, 0.08, 0.15],
                "recoverability_weight": [0.0, 0.05, 0.12],
                "stability_weight": [0.05, 0.12, 0.20],
                "oscillation_penalty": [0.08, 0.16, 0.24],
                "conflict_penalty": [0.08, 0.16, 0.24],
                "cost_penalty_weight": [0.0, 0.03, 0.06],
                "recovery_threshold": [0.45, 0.52, 0.60],
                "recoverability_keep_ratio": [0.4, 0.5, 0.65],
                "recoverability_noise_scale": [0.0, 0.03, 0.06],
                "recoverability_drop_fraction": [0.0, 0.10, 0.20],
                "recoverability_samples": [0, 1, 2],
                "topk_fraction": [0.10, 0.18, 0.28],
                "dimension_power": [0.0, 0.08, 0.18],
                "max_update_ratio": [0.10, 0.18, 0.28],
                "min_scale": [0.65, 0.8, 1.0],
                "max_scale": [1.4, 1.75, 2.0],
                "fallback_threshold": [0.0, 0.10, 0.20],
                "matrix_candidate_mode": ["row_column_consensus", "rank1_svd"],
                "row_column_mix": [0.4, 0.6, 0.8],
                "row_column_energy_weight": [0.35, 0.55, 0.75],
                "use_stable_consensus_candidate": [True, False],
                "consensus_memory_mix": [0.25, 0.42, 0.60],
                "consensus_matrix_mix": [0.0, 0.18, 0.32],
                "stable_consensus_bonus": [0.0, 0.12, 0.22],
                "matrix_consensus_bonus": [0.0, 0.06, 0.12],
                "stress_gate_threshold": [0.15, 0.28, 0.42],
                "stress_gate_power": [0.75, 1.0, 1.4],
                "stress_candidate_penalty": [0.0, 0.16, 0.28],
            },
            {
                "block_strategy": "tensor",
                "selection_mode": "fallback_to_gradient",
                ...
                "matrix_candidate_mode": "row_column_consensus",
                "row_column_mix": 0.5,
                "row_column_energy_weight": 0.5,
                "use_stable_consensus_candidate": False,
                "consensus_memory_mix": 0.0,
                "consensus_matrix_mix": 0.0,
        ...
        "block_direction_optimizer_v4_fast": OptimizerSpec(
            "block_direction_optimizer_v4_fast",
            BlockDirectionOptimizerV4Fast,
            {
                "lr": 1.5e-2,
                "weight_decay": 0.0,
                "block_strategy": "smart_v4",
                "selection_mode": "winner_take_all",
                "selection_temperature": 0.25,
                "memory_decay": 0.88,
                "smooth_decay": 0.96,
                ...
                "descent_weight": 0.52,
                "coherence_weight": 0.18,
                "improvement_weight": 0.04,
                "recoverability_weight": 0.0,
                "stability_weight": 0.16,
                "oscillation_penalty": 0.12,
                "conflict_penalty": 0.12,
                "cost_penalty_weight": 0.02,
                "recovery_threshold": 0.55,
                "recoverability_keep_ratio": 0.5,
                "recoverability_noise_scale": 0.02,
                "recoverability_drop_fraction": 0.10,
                "recoverability_samples": 0,
                "dimension_power": 0.06,
                "max_update_ratio": 0.16,
                "min_scale": 0.82,
                "max_scale": 1.45,
                "fallback_threshold": 0.06,
                "magnitude_mode": "energy_normalized",
                "use_gradient_candidate": True,
                "use_trusted_direction_candidate": True,
                "use_low_rank_candidate": True,
                "use_stable_consensus_candidate": True,
                "consensus_memory_mix": 0.38,
                "consensus_matrix_mix": 0.14,
                "stable_consensus_bonus": 0.10,
                "matrix_consensus_bonus": 0.05,
                "matrix_candidate_mode": "row_column_consensus",
                "row_column_mix": 0.6,
                "row_column_energy_weight": 0.55,
                "small_matrix_cutoff": 1024,
                "energy_decay": 0.97,
                "energy_power": 0.5,
                "use_typed_profiles": True,
                "use_recoverability_gate": False,
                "recoverability_interval": 8,
                "use_conv_structure_support": True,
                "conv_lr_scale": 0.88,
                "conv_coherence_weight": 0.22,
                "conv_stability_weight": 0.20,
                "conv_consensus_memory_mix": 0.44,
                "conv_consensus_matrix_mix": 0.12,
                "conv_stable_consensus_bonus": 0.08,
                "conv_matrix_consensus_bonus": 0.04,
                "conv_small_matrix_cutoff": 768,
                "conv_energy_power": 0.58,
                "conv_consensus_bonus": 0.0,
                "conv_memory_bonus": 0.0,
                "conv_fallback_relaxation": 0.0,
                "conv_max_update_ratio": 0.10,
                "conv_energy_power_bonus": 0.15,
                "conv_step_floor": 0.82,
                "conv_support_channel_weight": 0.40,
                "conv_support_spatial_weight": 0.35,
                "conv_support_bank_weight": 0.25,
                "conv_support_power": 1.0,
            },
            {
                "lr": [1.5e-2, 1.2e-2, 1.0e-2, 6e-3],
                "weight_decay": [0.0, 1e-5, 1e-4],
                "block_strategy": ["smart_v4", "tensor", "row"],
                "memory_decay": [0.84, 0.88, 0.92],
                "smooth_decay": [0.94, 0.96, 0.98],
                "grad_decay": [0.95, 0.97, 0.99],
                "trust_decay": [0.86, 0.90, 0.94],
                "descent_weight": [0.44, 0.52, 0.60],
                "coherence_weight": [0.10, 0.18, 0.26],
                "improvement_weight": [0.0, 0.04, 0.08],
                "stability_weight": [0.10, 0.16, 0.22],
                "oscillation_penalty": [0.08, 0.12, 0.18],
                "conflict_penalty": [0.08, 0.12, 0.18],
                "cost_penalty_weight": [0.0, 0.02, 0.04],
                "dimension_power": [0.0, 0.06, 0.12],
                "max_update_ratio": [0.10, 0.16, 0.24],
                "min_scale": [0.75, 0.82, 0.92],
                "max_scale": [1.30, 1.45, 1.60],
                "fallback_threshold": [0.0, 0.06, 0.12],
                "consensus_memory_mix": [0.25, 0.38, 0.50],
                "consensus_matrix_mix": [0.0, 0.14, 0.24],
                "stable_consensus_bonus": [0.04, 0.10, 0.16],
                "matrix_consensus_bonus": [0.0, 0.05, 0.10],
                "row_column_mix": [0.45, 0.60, 0.75],
                "row_column_energy_weight": [0.40, 0.55, 0.70],
                "small_matrix_cutoff": [256, 1024, 2048],
                "energy_decay": [0.94, 0.97, 0.99],
                "energy_power": [0.35, 0.5, 0.65],
                "use_typed_profiles": [True],
                "use_recoverability_gate": [False],
                "recoverability_interval": [8],
                "use_conv_structure_support": [True],
                "conv_lr_scale": [0.84, 0.88, 0.92],
                "conv_coherence_weight": [0.18, 0.22, 0.26],
                "conv_stability_weight": [0.16, 0.20, 0.24],
                "conv_consensus_memory_mix": [0.38, 0.44, 0.50],
                "conv_consensus_matrix_mix": [0.08, 0.12, 0.16],
                "conv_stable_consensus_bonus": [0.06, 0.08, 0.10],
                "conv_matrix_consensus_bonus": [0.02, 0.04, 0.06],
                "conv_small_matrix_cutoff": [512, 768, 1024],
                "conv_energy_power": [0.50, 0.58, 0.66],
                "conv_consensus_bonus": [0.0],
                "conv_memory_bonus": [0.0],
                "conv_fallback_relaxation": [0.0],
                "conv_max_update_ratio": [0.08, 0.10, 0.12],
                "conv_energy_power_bonus": [0.10, 0.15, 0.18],
                "conv_step_floor": [0.74, 0.82, 0.88],
                "conv_support_channel_weight": [0.30, 0.40, 0.50],
                "conv_support_spatial_weight": [0.20, 0.35, 0.45],
                "conv_support_bank_weight": [0.10, 0.25, 0.35],
                "conv_support_power": [0.75, 1.0, 1.5],
            },
            {
                "block_strategy": "tensor",
                "selection_mode": "winner_take_all",
                ...
                "row_column_mix": 0.5,
                "row_column_energy_weight": 0.5,
                "small_matrix_cutoff": 2048,
                "energy_decay": 1.0,
                "energy_power": 0.0,
                "use_typed_profiles": False,
                "use_recoverability_gate": False,
                "recoverability_interval": 999999,
                "use_conv_structure_support": False,
                "conv_lr_scale": 1.0,
                "conv_coherence_weight": 0.0,
                "conv_stability_weight": 0.0,
                "conv_consensus_memory_mix": 0.0,
                "conv_consensus_matrix_mix": 0.0,
                "conv_stable_consensus_bonus": 0.0,
                "conv_matrix_consensus_bonus": 0.0,
                "conv_small_matrix_cutoff": 2048,
                "conv_energy_power": 0.0,
                "conv_consensus_bonus": 0.0,
                "conv_memory_bonus": 0.0,
                "conv_fallback_relaxation": 0.0,
                "conv_max_update_ratio": 1.0,
                "conv_energy_power_bonus": 0.0,
                "conv_step_floor": 1.0,
                "conv_support_channel_weight": 0.0,
                "conv_support_spatial_weight": 0.0,
                "conv_support_bank_weight": 0.0,
                "conv_support_power": 1.0,
            },
        ),
        "block_direction_optimizer_v4_fast_legacy": OptimizerSpec(
            ...
            BlockDirectionOptimizerV4Fast,
            {
                ...
                "use_conv_structure_support": False,
                "conv_lr_scale": 1.0,
                "conv_coherence_weight": 0.18,
                "conv_stability_weight": 0.16,
                "conv_consensus_memory_mix": 0.38,
                "conv_consensus_matrix_mix": 0.14,
                "conv_stable_consensus_bonus": 0.10,
                "conv_matrix_consensus_bonus": 0.05,
                "conv_small_matrix_cutoff": 1024,
                "conv_energy_power": 0.5,
                "conv_consensus_bonus": 0.0,
                "conv_memory_bonus": 0.0,
                "conv_fallback_relaxation": 0.0,
                "conv_max_update_ratio": 1.0,
            ...
            },
            {
                ...
                "energy_decay": [0.94, 0.97, 0.99],
                "energy_power": [0.35, 0.5, 0.65],
                "use_recoverability_gate": [False, True],
                "recoverability_interval": [4, 8, 12],
            },
            {},
        ),
        "block_direction_optimizer_v41": OptimizerSpec(
            "block_direction_optimizer_v41",
            BlockDirectionOptimizerV41,
            {
                "lr": 1.2e-2,
                "weight_decay": 0.0,
                "block_strategy": "smart_v4",
                ...
                "use_low_rank_candidate": True,
                "use_stable_consensus_candidate": True,
                "use_filter_consensus_candidate": False,
                "consensus_memory_mix": 0.44,
                "consensus_matrix_mix": 0.12,
                "stable_consensus_bonus": 0.08,
                "matrix_consensus_bonus": 0.04,
                "filter_consensus_bonus": 0.10,
                "filter_channel_mix": 0.18,
                "filter_spatial_mix": 0.20,
                "filter_bank_mix": 0.10,
                "matrix_candidate_mode": "row_column_consensus",
                "row_column_mix": 0.6,
                "row_column_energy_weight": 0.55,
                "small_matrix_cutoff": 768,
                "energy_decay": 0.97,
                "energy_power": 0.58,
                "use_recoverability_gate": False,
                "recoverability_interval": 8,
            ...
            {
                "lr": [1.5e-2, 1.2e-2, 8e-3],
                "weight_decay": [0.0, 1e-5, 1e-4],
                "block_strategy": ["smart_v4", "tensor", "row"],
                "memory_decay": [0.84, 0.88, 0.92],
                "smooth_decay": [0.92, 0.94, 0.96],
                "grad_decay": [0.95, 0.97, 0.99],
                "trust_decay": [0.86, 0.90, 0.94],
                "descent_weight": [0.44, 0.52, 0.60],
                "coherence_weight": [0.16, 0.22, 0.28],
                "improvement_weight": [0.0, 0.04, 0.08],
                "stability_weight": [0.16, 0.20, 0.24],
                "oscillation_penalty": [0.08, 0.12, 0.18],
                "conflict_penalty": [0.08, 0.12, 0.18],
                "cost_penalty_weight": [0.0, 0.02, 0.04],
                "dimension_power": [0.0, 0.06, 0.12],
                "max_update_ratio": [0.10, 0.16, 0.22],
                "min_scale": [0.75, 0.82, 0.90],
                "max_scale": [1.30, 1.45, 1.60],
                "fallback_threshold": [0.0, 0.06, 0.12],
                "consensus_memory_mix": [0.34, 0.44, 0.54],
                "consensus_matrix_mix": [0.0, 0.12, 0.20],
                "stable_consensus_bonus": [0.04, 0.08, 0.12],
                "matrix_consensus_bonus": [0.0, 0.04, 0.08],
                "filter_consensus_bonus": [0.04, 0.10, 0.16],
                "filter_channel_mix": [0.10, 0.18, 0.28],
                "filter_spatial_mix": [0.10, 0.20, 0.30],
                "filter_bank_mix": [0.0, 0.10, 0.20],
                "use_filter_consensus_candidate": [False, True],
                "row_column_mix": [0.45, 0.60, 0.75],
                "row_column_energy_weight": [0.40, 0.55, 0.70],
                "small_matrix_cutoff": [512, 768, 1024],
                "energy_decay": [0.94, 0.97, 0.99],
                "energy_power": [0.45, 0.58, 0.70],
                "use_recoverability_gate": [False, True],
                "recoverability_interval": [4, 8, 12],
                "conv_max_update_ratio": [0.06, 0.10, 0.14],
                "conv_energy_power_bonus": [0.08, 0.15, 0.24],
                "conv_step_floor": [0.74, 0.82, 0.90],
            },
            {
                "block_strategy": "tensor",
                "selection_mode": "winner_take_all",
                ...
                "stable_consensus_bonus": 0.0,
                "matrix_consensus_bonus": 0.0,
                "filter_consensus_bonus": 0.0,
                "filter_channel_mix": 0.0,
                "filter_spatial_mix": 0.0,
                "filter_bank_mix": 0.0,
                "matrix_candidate_mode": "row_column_consensus",
                "row_column_mix": 0.5,
                "row_column_energy_weight": 0.5,
        ...
        "block_direction_optimizer_v42": OptimizerSpec(
            ...
            BlockDirectionOptimizerV42,
            {
                ...
                "use_recoverability_gate": False,
                "recoverability_interval": 8,
                "conv_consensus_bonus": 0.12,
                "conv_memory_bonus": 0.08,
                "conv_fallback_relaxation": 0.05,
                "conv_max_update_ratio": 0.10,
                "conv_energy_power_bonus": 0.15,
                "conv_step_floor": 0.82,
            },
            {
                ...
                "use_recoverability_gate": [False, True],
                "recoverability_interval": [4, 8, 12],
                "conv_consensus_bonus": [0.06, 0.12, 0.18],
                "conv_memory_bonus": [0.04, 0.08, 0.12],
                "conv_fallback_relaxation": [0.0, 0.05, 0.10],
                "conv_max_update_ratio": [0.06, 0.10, 0.14],
                "conv_energy_power_bonus": [0.08, 0.15, 0.24],
                "conv_step_floor": [0.74, 0.82, 0.90],
            },
        ...
        "block_direction_optimizer_v43": OptimizerSpec(
            "block_direction_optimizer_v43",
            BlockDirectionOptimizerV43,
            {
                "lr": 1.5e-2,
                "weight_decay": 0.0,
                "block_strategy": "smart_v4",
                ...
                "conv_fallback_relaxation": 0.0,
                "conv_max_update_ratio": 0.10,
                "conv_energy_power_bonus": 0.18,
                "conv_step_floor": 0.80,
                "conv_support_threshold": 0.0,
                "conv_support_power": 1.0,
            },
            {
                "lr": [1.8e-2, 1.5e-2, 1.2e-2],
                "weight_decay": [0.0, 1e-5, 1e-4],
                "block_strategy": ["smart_v4", "tensor", "row"],
                "memory_decay": [0.84, 0.88, 0.92],
                "smooth_decay": [0.94, 0.96, 0.98],
                ...
                "trust_decay": [0.86, 0.90, 0.94],
                "descent_weight": [0.44, 0.52, 0.60],
                "coherence_weight": [0.14, 0.18, 0.22],
                "improvement_weight": [0.0, 0.04, 0.08],
                "stability_weight": [0.12, 0.16, 0.20],
                "oscillation_penalty": [0.08, 0.12, 0.18],
                "conflict_penalty": [0.08, 0.12, 0.18],
                "cost_penalty_weight": [0.0, 0.02, 0.04],
                "dimension_power": [0.0, 0.06, 0.12],
                ...
                "max_scale": [1.30, 1.45, 1.60],
                "fallback_threshold": [0.0, 0.06, 0.12],
                "consensus_memory_mix": [0.30, 0.38, 0.48],
                "consensus_matrix_mix": [0.08, 0.14, 0.20],
                "stable_consensus_bonus": [0.06, 0.10, 0.14],
                "matrix_consensus_bonus": [0.02, 0.05, 0.08],
                "row_column_mix": [0.50, 0.60, 0.70],
                "row_column_energy_weight": [0.45, 0.55, 0.65],
                "small_matrix_cutoff": [768, 1024],
                "energy_power": [0.42, 0.50, 0.60],
                "conv_consensus_bonus": [0.0],
                "conv_memory_bonus": [0.0],
                "conv_fallback_relaxation": [0.0],
                "conv_max_update_ratio": [0.08, 0.10, 0.12],
                "conv_energy_power_bonus": [0.08, 0.18, 0.28],
                "conv_step_floor": [0.74, 0.80, 0.88],
                "conv_support_threshold": [0.0],
                "conv_support_power": [1.0],
            },
            {
        ...
        "block_direction_optimizer_v44": OptimizerSpec(
            "block_direction_optimizer_v44",
            BlockDirectionOptimizerV44,
            {
                "lr": 1.5e-2,
                "weight_decay": 0.0,
                "block_strategy": "smart_v4",
            ...
            },
            {
                ...
                "conv_energy_power": [0.50, 0.58, 0.66],
                "conv_max_update_ratio": [0.08, 0.10, 0.12],
                "conv_energy_power_bonus": [0.10, 0.18, 0.26],
                "conv_step_floor": [0.74, 0.80, 0.88],
                "conv_consensus_bonus": [0.0],
                "conv_memory_bonus": [0.0],
                "conv_fallback_relaxation": [0.0],
        ...
        "block_direction_optimizer_v45": OptimizerSpec(
            "block_direction_optimizer_v45",
            BlockDirectionOptimizerV45,
            {
                "lr": 1.5e-2,
                "weight_decay": 0.0,
                "block_strategy": "smart_v4",
                ...
                "conv_energy_power_bonus": 0.18,
                "conv_step_floor": 0.80,
                "route_temperature": 0.72,
                "stable_route_bias": 0.12,
                "structured_route_bias": 0.0,
                "stress_route_bias": -0.02,
                "stable_route_weight": 1.0,
                "structured_route_weight": 1.0,
                "stress_route_weight": 1.05,
                "route_stress_scale": 1.35,
                "route_update_pressure_scale": 0.35,
                "stable_route_bonus": 0.08,
                "structured_route_bonus": 0.08,
                "stress_route_bonus": 0.09,
                "stress_memory_penalty": 0.04,
                "route_threshold_relaxation": 0.04,
                "route_step_gain": 0.04,
                "route_stress_damping": 0.03,
            },
            {
                "lr": [1.8e-2, 1.5e-2, 1.2e-2],
                "weight_decay": [0.0, 1e-5, 1e-4],
                ...
                "conv_energy_power_bonus": [0.10, 0.18, 0.26],
                "conv_step_floor": [0.74, 0.80, 0.88],
                "route_temperature": [0.55, 0.72, 0.90],
                "stable_route_bias": [0.04, 0.12, 0.20],
                "structured_route_bias": [-0.05, 0.0, 0.05],
                "stress_route_bias": [-0.08, -0.02, 0.04],
                "stable_route_weight": [0.8, 1.0, 1.2],
                "structured_route_weight": [0.8, 1.0, 1.2],
                "stress_route_weight": [0.9, 1.05, 1.2],
                "route_stress_scale": [1.0, 1.35, 1.7],
                "route_update_pressure_scale": [0.25, 0.35, 0.50],
                "stable_route_bonus": [0.04, 0.08, 0.12],
                "structured_route_bonus": [0.04, 0.08, 0.12],
                "stress_route_bonus": [0.05, 0.09, 0.13],
                "stress_memory_penalty": [0.0, 0.04, 0.08],
                "route_threshold_relaxation": [0.0, 0.04, 0.08],
                "route_step_gain": [0.0, 0.04, 0.08],
                "route_stress_damping": [0.0, 0.03, 0.06],
            },
            {
                "block_strategy": "tensor",
                "selection_mode": "winner_take_all",
                ...
                "stable_route_bias": 0.0,
                "structured_route_bias": 0.0,
                "stress_route_bias": 0.0,
                "stable_route_weight": 0.0,
                "structured_route_weight": 0.0,
                "stress_route_weight": 0.0,
                "route_stress_scale": 1.0,
                "route_update_pressure_scale": 1.0,
                "stable_route_bonus": 0.0,
                "structured_route_bonus": 0.0,
                "stress_route_bonus": 0.0,
                "stress_memory_penalty": 0.0,
                "route_threshold_relaxation": 0.0,
                "route_step_gain": 0.0,
                "route_stress_damping": 0.0,
            },
        ),
        "observation_recovery_optimizer": OptimizerSpec(
            "observation_recovery_optimizer",
            ObservationRecoveryOptimizer,
            {
                "lr": 4e-3,
                "weight_decay": 1e-4,
                "view_count": 3,
                ...
                "corruption_std": 0.03,
                "recoverability_strength": 0.55,
                "disagreement_penalty": 0.24,
                "memory_strength": 0.20,
                "memory_decay": 0.90,
                "dimension_power": 0.20,
            ...
            {
                "lr": [1e-2, 4e-3, 2e-3, 1e-3],
                "weight_decay": [0.0, 1e-4, 1e-3],
                "view_count": [2, 3, 4],
                "keep_probability": [0.4, 0.6, 0.8],
                "corruption_std": [0.0, 0.03, 0.06],
                "recoverability_strength": [0.25, 0.55, 0.85],
                "disagreement_penalty": [0.1, 0.24, 0.4],
                "memory_strength": [0.0, 0.2, 0.35],
                "memory_decay": [0.8, 0.9, 0.96],
                "dimension_power": [0.0, 0.2, 0.35],
