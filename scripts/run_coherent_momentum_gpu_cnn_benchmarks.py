...
from optimizer_research import load_yaml_config, run_coherent_momentum_gpu_cnn_benchmarks  # noqa: E402
...
if __name__ == "__main__":
    ...
    frame = run_coherent_momentum_gpu_cnn_benchmarks(config)
